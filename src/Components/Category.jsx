    ...
    return (
        <div style={{ display: 'flex', backgroundColor: 'transparent' }}>
            <CardGroup style={{ display: 'flex', flexDirection: 'column', backgroundColor: 'transparent' }}>
                <Card style={{ alignSelf: 'flex-start', width: '10vw', fontSize: '1vw', backgroundColor: 'transparent', margin:"20px" }}>
                ...
                <Card style={{ width: '10vw', fontSize: '1vw', backgroundColor: 'transparent', margin:"20px" }}>
