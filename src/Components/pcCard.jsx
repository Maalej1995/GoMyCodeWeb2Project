...
function PcCard(props) {
    ...
    return (
        <Card style={{ width: '20rem', height: 'auto', backgroundColor: 'transparent', margin: '20px', border: 'none' }}>
            ...
            <Button variant="secondary" onClick={() => setModalIsShown(true)}>More Details</Button>{' '}
            ...
            <Modal show={modalIsShown} onHide={() => setModalIsShown(false)}>
                ...
                <Modal.Body style={{textAlign: 'center'}}>
                    ...
                    <ListGroupItem style={{ backgroundColor: 'transparent', fontSize: '1vw' }} >Screen : {array[0].screen}</ListGroupItem>
                    <ListGroupItem style={{ backgroundColor: 'transparent', fontSize: '1vw' }} >Processor : {array[0].processor}</ListGroupItem>
                    <ListGroupItem style={{ backgroundColor: 'transparent', fontSize: '1vw' }} >RAM : {array[0].ram}</ListGroupItem>
                    <ListGroupItem style={{ backgroundColor: 'transparent', fontSize: '1vw' }} >Graphics : {array[0].graphic}</ListGroupItem>
                    <ListGroupItem style={{ backgroundColor: 'transparent', fontSize: '1vw' }} >Disk : {array[0].disk}</ListGroupItem>
                </Modal.Body>
                <Modal.Footer>
